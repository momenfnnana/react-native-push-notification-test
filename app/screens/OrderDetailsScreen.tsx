...
import {
  ...
  DriverReachRestaurantScreenRouteProp,
} from '@navigators';
import {
  Button,
  ContentContainer,
...
export const OrderDetailsScreen: FC<
  StackScreenProps<HomeStackNavigatorParamList, 'OrderDetails'>
        ...
        <View style={[$card, {marginTop: spacing.medium}]}>
          ...
          <View style={$itemRow}>
            ...
            <Text
              ...
              text={`${orderData?.data?.travelCost} ₪`}
            />
          </View>
          <Divider style={{marginVertical: spacing.small}} />
          <View style={$itemRow}>
            ...
            <Text
              style={[$valueItem, {color: colors.primary}]}
              text={`${orderData?.data?.paidAmount} ₪`}
            />
          </View>
          <Divider style={{marginVertical: spacing.small}} />
          <View style={$itemRow}>

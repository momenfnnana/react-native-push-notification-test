...
> = observer(function ContactUsScreen() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    Address: Yup.string().required(translate('validation.required')),
    MessageBody: Yup.string().required(translate('validation.required')),
  });
      ...
      <ContentContainer>
        <View style={{width: '100%'}}>
          ...
          <TextField
            ...
            status={
              touched.MessageBody && errors.MessageBody ? 'error' : undefined
            }
          ...
          <InfoSection
            ...
            rightIcon={
              <Image source={PhoneNumberIcon} style={styles.phoneIcon} />
            }
          />
        </View>
      </ContentContainer>

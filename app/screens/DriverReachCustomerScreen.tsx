...
export const DriverReachCustomerScreen: FC<DriverReachCustomerScreenRouteProp> = observer(
  function DriverReachCustomerScreen() {
    ...
    const { mutate, isLoading: isSubmitLoading } = useMutation(DriverReachCustomer, {
      onSuccess: () => {

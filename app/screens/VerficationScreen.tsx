...
export const VerficationScreen: FC<
  StackScreenProps<AppStackScreenProps, 'Verfication'>
> = observer(function VerficationScreen() {
  ...
  const ForgetPasswordSchema = Yup.object().shape({
    Code: Yup.string().required(translate('validation.required')).length(6),
  });
      ...
      <Card
        ...
        ContentComponent={
          <>
            ...
            />
            {errors.Code && (
              <Text style={{color: colors.rejected, textAlign: 'center'}}>
                {errors.Code}
              </Text>
            )}
            <Button

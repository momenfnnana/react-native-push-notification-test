    ...
    <Pressable style={$viewStyle} accessibilityRole="button" {...rest}>
      {(state) => (
        <>
          ...
          <View style={$row}>
            {isLoading && <ActivityIndicator color={colors.palette.neutral100} style={$loader} />}
...
const $viewPresets = {
  ...
  filled: [
    $baseViewStyle,
    { borderWidth: 1, borderColor: colors.transparent, backgroundColor: colors.primary },
  ] as StyleProp<ViewStyle>,

  reversed: [
    $baseViewStyle,
    { borderWidth: 1, borderColor: colors.primary, backgroundColor: colors.transparent },
  ] as StyleProp<ViewStyle>,
}

const $textPresets: Record<Presets, StyleProp<TextStyle>> = {
  default: [$baseTextStyle, { color: colors.primary }],
...
const $loader: ActivityIndicatorProps["style"] = {

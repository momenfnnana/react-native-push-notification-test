...
const ar: Translations = {
  ...
  common: {
    ...
    setting: "الإعدادات",
    or: "أو",
    openLocation: "من فضلك قم بتفعيل السماح للوصول الى موقعك الحالي لامكانية ارسال موقعك",
    cancel: "حذف",
    back: "خلف",
    logOut: "تسجيل الخروج",
  ...
  forgetPasswordScreen: {
    ...
    description: "الرجاء ادخال رقم الجوال , سيتم ارسال رسالة نصية بالرمز لاستعادة كلمة المرور",
    submitBtn: "تأكيد ",
  },
  resetPasswordScreen: {
